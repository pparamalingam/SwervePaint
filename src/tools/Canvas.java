...
public class Canvas extends Shape {
		...
		public void groupThemShapes() {
			...
			System.out.println(_shapes.size() + "wat dis size _shape");
			System.out.println(indexes.size() + "wat dis size index");
			System.out.println(_shapes);
			System.out.println(newCanvas.getShapeList());
			for(int i=indexes.size()-1; i>=0; i--){
				//_shapes.get(i).setVisible(false);
				//_shapes.remove(newCanvas.getShapeList().get(i));
			}
